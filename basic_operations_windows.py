...
time.sleep(1)
work = print(f"Welcome to Python {sys.version_info.major}.{sys.version_info.minor}!")
time.sleep(1.5)
print("List basic operations for Windows:")
print("1. Sleep (This command require run as administrator)")
print("2. Shutdown")
print("3. Reboot")
print(f"4. Open video how to run Python {sys.version_info.major}.{sys.version_info.minor} as administrator")
print("5. Open GitHub ")
print(f"6. Exit from Python {sys.version_info.major}.{sys.version_info.minor}")
time.sleep(0.5)
work = input("Select your operation [1/2/3/4/5/6]: ")
...
if work == "4":
    print(f"Opening video how to run Python {sys.version_info.major}.{sys.version_info.minor} as administrator...")
    time.sleep(3)
    wb.open("")
...
if work == "6":
    ...
    print("Invalid input! You need to enter the choice correctly! [1/2/3/4/5/6]")
    time.sleep(3)
    sys.exit()
